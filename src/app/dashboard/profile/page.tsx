                        ...
                        <div className="animate-in fade-in slide-in-from-right-4 duration-300">
                            ...
                            <form onSubmit={handleSaveProfile} className="space-y-6 max-w-lg">
                                ...
                                <div>
                                    ...
                                    <input type="email" value={email} disabled aria-label="Email do usuário" className="w-full px-4 py-2 border rounded-lg bg-gray-50 text-gray-500 cursor-not-allowed" />
                                </div>
